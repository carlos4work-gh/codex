...
mod agent;
pub use agent::role::AgentRoleOrigin;
pub use agent::role::EffectiveAgentRole;
pub use agent::role::apply_role_to_config_for_multi_agent_v2;
pub use agent::role::effective_role_catalog;
